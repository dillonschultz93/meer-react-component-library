...
<Canvas>
  <Story name="Basic/Default">
    {() => {
      ...
      return (<TextInput id="basic" name="basic" type="text" placeholder="Enter text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} />);
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Basic/Label">
    {() => {
      const [inputValue, setInputValue] = useState('');
      return (<TextInput id="label" name="label" type="text" placeholder="Enter your name" label="Name" value={inputValue} onChange={(e) => setInputValue(e.target.value)} />);
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Basic/Icon/Persentational">
    {() => {
      const [inputValue, setInputValue] = useState('');
      return (<TextInput id="icon" name="icon" type="text" placeholder="Enter your name" label="Name" icon={{name: 'person'}} value={inputValue} onChange={(e) => setInputValue(e.target.value)} />);
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Basic/Icon/Interactive">
    {() => {
      ...
      return (<TextInput id="icon-interactive" name="icon-interactive" type={toggled ? 'text' : 'password'} placeholder="Enter your password" label="Password" icon={{name: toggled ? 'eyeOff' : 'eyeOn', interactive: true, interactiveMethod: () => setToggled(!toggled)}} value={inputValue} onChange={(e) => setInputValue(e.target.value)} />);
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Validation/Required">
    {() => {
      ...
      return (<TextInput id="required" name="required" type="email" placeholder="Enter your email" label="Email" icon={{name: 'mail'}} value={inputValue} onChange={(e) => setInputValue(e.target.value)} required validationState={validation} onBlur={handleOnBlur} />);
    }}
  </Story>
</Canvas>
